    ...
    <div className="min-h-screen bg-gray-950 pb-20">
      ...
      <main className="max-w-3xl mx-auto px-4 pt-12 animate-fade-in">
        ...
        <div className="text-center mb-12">
          <div
            className="inline-flex items-center gap-2 bg-brand-500/10 border border-brand-500/20
        ...
        <div className="card p-6 mb-10">
          ...
          <ol className="space-y-3">
            {STEPS.map((step, i) => (
              ...
              >
                <span
                  className="flex-shrink-0 w-6 h-6 rounded-full bg-brand-500/20
